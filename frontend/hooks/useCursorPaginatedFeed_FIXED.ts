// 🚀 FEED PAGINADO POR CURSOR - VERSIÓN CORREGIDA
// Optimizado para índices idx_* creados en producción
// Usa created_at como cursor (last_timestamp)

import { useQuery, useInfiniteQuery, useQueryClient } from '@tanstack/react-query';
import { supabase } from '../integrations/supabase/client'; // Ajustar ruta según tu proyecto
...
// ========================================
// HOOKS REACT CON SCROLL INFINITO (CORREGIDOS)
// ========================================
...
export function useInfiniteReactions(options: {
  ...
  return useInfiniteQuery<ReactionsResponse>({
  ...
  const markNotificationAsRead = async (notificationId: string) => {
    ...
    queryClient.setQueriesData(
      ...
      (oldData: any) => {
        ...
        return {
          ...oldData,
          pages: oldData.pages.map((page: NotificationsResponse) => ({
            ...page,
