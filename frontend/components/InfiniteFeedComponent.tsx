// 🚀 COMPONENTE FEED INFINITO - REACT/TYPESCRIPT
// Implementación con scroll infinito y paginación por cursor
// Optimizado para índices idx_* de Supabase

import React, { useCallback, useRef, useEffect } from 'react';
import { useInfiniteFeed, useFeedUtils } from '../hooks/useCursorPaginatedFeed';
import { Post } from '../hooks/useCursorPaginatedFeed';
...
export const InfiniteFeedComponent: React.FC<InfiniteFeedProps> = ({
  ...
  const handleScroll = useCallback(() => {
    ...
    // Cargar más cuando el usuario esté al 80% del final
    if (scrollPercentage > 80 && !isFetchingNextPage) {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="mt-2 text-gray-500">Cargando feed...</p>
      </div>
    );
  }
